! function(e) {
    ...
    i("#mainContent").hide(), i(".swiper-container").hide(), i(".ani2").on("tap", function() { i("#mainContent").show(), i(".swiper-container").hide(), i.getJSON("https://yanchengye.github.io/ycyrepo/mock/skill.json", {}, function(e) {
        ...
        new s("#wrapper", { mouseWheel: !0, scrollbars: !0 });
        document.addEventListener("touchmove", function(e) { e.preventDefault() }, !1) }), i("#footer div").tap(function() {
        var e = i(this).attr("id");
        i(this).addClass("active").siblings().removeClass("active"), i.getJSON("https://yanchengye.github.io/ycyrepo/mock/" + e + ".json", {}, function(t) {
            var n = "";
        ...
        new s("#wrapper", { mouseWheel: !0, scrollbars: !0 });
        document.addEventListener("touchmove", function(e) { e.preventDefault() }, !1) }), i("#scroller ul").on("tap", "li", function() { i(this).css("background-color", "#F0F0F0").siblings().css("background-color", "#fff") }), i("#header span:nth-child(1)").on("tap", function() { console.log(i(this)), alert("scan QRCode!") }), i("#header span:nth-child(3)").on("tap", function() { console.log(i(this)), alert("shaer to friends!") });
    ...
    ! function(e) {
        ...
        function r() { o && clearTimeout(o), l && clearTimeout(l), c && clearTimeout(c), u && clearTimeout(u), o = l = c = u = null, d = {} }
        ...
        var t, n = function(e, r) {
            ...
            if (x.params = r, x.originalParams = m, x.classNames = [], "undefined" != typeof t && "undefined" != typeof i && (t = i), ("undefined" != typeof t || (t = "undefined" == typeof i ? window.Dom7 || window.Zepto || window.jQuery : i)) && (x.$ = t, x.currentBreakpoint = void 0, x.getActiveBreakpoint = function() {
                                    ...
                                    if (O || !x.browser.ieTouch) { x.allowClick = !1, x.emit("onSliderMove", x, e), e.preventDefault(), x.params.touchMoveStopPropagation && !x.params.nested && e.stopPropagation(), C || (r.loop && x.fixLoop(), N = x.getWrapperTranslate(), x.setWrapperTransition(0), x.animating && x.wrapper.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"), x.params.autoplay && x.autoplaying && (x.params.autoplayDisableOnInteraction ? x.stopAutoplay() : x.pauseAutoplay()), A = !1, x.params.grabCursor && (x.container[0].style.cursor = "move", x.container[0].style.cursor = "-webkit-grabbing", x.container[0].style.cursor = "-moz-grabbin", x.container[0].style.cursor = "grabbing")), C = !0;
                                        ...
                                        if (i > 0 && M > x.minTranslate() ? (a = !1, x.params.resistance && (M = x.minTranslate() - 1 + Math.pow(-x.minTranslate() + N + i, x.params.resistanceRatio))) : 0 > i && M < x.maxTranslate() && (a = !1, x.params.resistance && (M = x.maxTranslate() + 1 - Math.pow(x.maxTranslate() - N - i, x.params.resistanceRatio))), a && (e.preventedByNestedSwiper = !0), !x.params.allowSwipeToNext && "next" === x.swipeDirection && N > M && (M = N), !x.params.allowSwipeToPrev && "prev" === x.swipeDirection && M > N && (M = N), x.params.followFinger) {
                                            if (x.params.threshold > 0) {
                                                ...
                                                if (!D) return D = !0, x.touches.startX = x.touches.currentX, x.touches.startY = x.touches.currentY, M = N, void(x.touches.diff = x.isHorizontal() ? x.touches.currentX - x.touches.startX : x.touches.currentY - x.touches.startY) }(x.params.freeMode || x.params.watchSlidesProgress) && x.updateActiveIndex(), x.params.freeMode && (0 === B.length && B.push({ position: x.touches[x.isHorizontal() ? "startX" : "startY"], time: k }), B.push({ position: x.touches[x.isHorizontal() ? "currentX" : "currentY"], time: (new window.Date).getTime() })), x.updateProgress(M), x.setWrapperTranslate(M) } } } } } }, x.onTouchEnd = function(e) {
                ...
                return x.callPlugins = function(e) {
                    ...
                    onEnterKey: function(e) { 13 === e.keyCode && (t(e.target).is(x.params.nextButton) ? (x.onClickNext(e), x.isEnd ? x.a11y.notify(x.params.lastSlideMessage) : x.a11y.notify(x.params.nextSlideMessage)) : t(e.target).is(x.params.prevButton) && (x.onClickPrev(e), x.isBeginning ? x.a11y.notify(x.params.firstSlideMessage) : x.a11y.notify(x.params.prevSlideMessage)), t(e.target).is("." + x.params.bulletClass) && t(e.target)[0].click()) },
        ...
        o.prototype = {
            ...
            scrollToElement: function(e, t, n, i, r) {
                if (e = e.nodeType ? e : this.scroller.querySelector(e)) {
                    var a = p.offset(e);
                    a.left -= this.wrapperOffset.left, a.top -= this.wrapperOffset.top, n === !0 && (n = s.round(e.offsetWidth / 2 - this.wrapper.offsetWidth / 2)), i === !0 && (i = s.round(e.offsetHeight / 2 - this.wrapper.offsetHeight / 2)), a.left -= n || 0, a.top -= i || 0, a.left = a.left > 0 ? 0 : a.left < this.maxScrollX ? this.maxScrollX : a.left, a.top = a.top > 0 ? 0 : a.top < this.maxScrollY ? this.maxScrollY : a.top, t = void 0 === t || null === t || "auto" === t ? s.max(s.abs(this.x - a.left), s.abs(this.y - a.top)) : t, this.scrollTo(a.left, a.top, t, r) } },
    ...
    ! function(t, n) { "object" == typeof e && "object" == typeof e.exports ? e.exports = t.document ? n(t, !0) : function(e) {
        ...
        ge.ownFirst = "0" === Ie, ge.inlineBlockNeedsLayout = !1, ye(function() {
                ...
                n = le.getElementsByTagName("body")[0], n && n.style && (t = le.createElement("div"), i = le.createElement("div"), i.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", n.appendChild(i).appendChild(t), "undefined" != typeof t.style.zoom && (t.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1",
                    ge.inlineBlockNeedsLayout = e = 3 === t.offsetWidth, e && (n.style.zoom = 1)), n.removeChild(i))
            }),
            function() {
